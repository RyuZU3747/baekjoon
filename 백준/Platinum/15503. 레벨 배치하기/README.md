# [Platinum IV] 레벨 배치하기 - 15503 

[문제 링크](https://www.acmicpc.net/problem/15503) 

### 성능 요약

메모리: 23116 KB, 시간: 592 ms
...
<p>취미로 게임 만드는 걸 좋아하는 현욱은 오늘 간단한 게임 기획을 하나 떠올렸다. 현욱이 생각한 게임에는 N개의 레벨이 있는데, 각 레벨을 클리어하면 플레이어는 일정량의 점수를 획득할 수 있다. 또, 각 레벨은 클리어 후 진행할 수 있는 다음 레벨이 몇 종류 정해져있고, 플레이어는 그 레벨들 중 하나를 골라 해당 레벨로 진행할 수 있다.</p>
